					...
					<div className="grid grid-cols-3 p-4 rounded-md shadow-neumorphism">
						...
						>
							...
							>
								...
								<CollapsibleContent>
									<div className="grid items-center grid-cols-2 gap-3 pb-3">
										<SelectComponent
											name="material"
											label="Kain"
											placeholder="Pilih"
							...
							<InputComponent
								...
								disabled={modalProps.type == "detail"}
							/>
							<div className="grid grid-cols-1 gap-3 py-3 border-t border-gray-500 lg:grid-cols-2 lg:col-span-2 items-self-end">
