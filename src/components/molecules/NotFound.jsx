...
const NotFound = () => {
  return (
		<div class="bg-bg-neumorphism h-screen flex flex-col justify-center gap-10">
			<center>
				<svg
					class="emoji-404 "
			...
			<center>
				<Link
					href="/"
					class="text-gray-500 font-mono text-xl bg-bg-neumorphism p-3 rounded-md hover:shadow-md shadow-neumorphism"
				>
					Go Home{" "}
				</Link>
			</center>
