    ...
    case "validation":
      columns.push({
        ...
        cell: (row) => (
          ...
          <Button variant="ghost" onClick={() => handleApprove(row)}>
            <CheckIcon className="w-5 h-5 text-green-700" title="Approve" />
          </Button>
					<Button variant="ghost" onClick={() => handleReview(row.id)}>
						<DocumentTextIcon className="w-5 h-5 text-orange-700" title="Review" />
					</Button>
					</div>
        ),
        allowOverflow: true,
